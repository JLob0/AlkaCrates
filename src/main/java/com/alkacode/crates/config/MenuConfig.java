...
/**
 * Centraliza titulos/nomes/lores de TODAS as GUIs do AlkaCrates no menus.yml -
...
public final class MenuConfig {
     ...
     * prefixo/estado dinamico escolhido em runtime pelo Java). */
    ...
    /** Lore como MiniMessage cru (sem virar Component) - usado por helpers que recebem
     * String... e parseiam por conta propria (ex: BaseGui#createItem). */
